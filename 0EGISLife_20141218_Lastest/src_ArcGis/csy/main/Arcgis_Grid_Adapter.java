...
public class Arcgis_Grid_Adapter extends ArrayAdapter<String> {
    ...
    public Arcgis_Grid_Adapter(final Context context, final int textViewResourceId, List<GridItem> gridItemList) {
    ...
    public Arcgis_Grid_Adapter(final Context context, final int textViewResourceId, final String[] title, final String[] time) {
    	super(context, textViewResourceId);
    	mLayoutInflater = LayoutInflater.from(context);
        mRandom = new Random();
        mBackgroundColors = new ArrayList<Integer>();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.arcgis_list_item_threed, parent, false);
            vh = new ViewHolder();
